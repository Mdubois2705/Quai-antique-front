...
export const allRoutes = [
    ...
    new Route("/carte", "La Carte", "/pages/carte/carte.html"),
    new Route("/menubistrot", "Menu Bistrot", "/pages/carte/menubistrot.html"),
    new Route("/boisson", "Carte des Boissons", "/pages/carte/boisson.html"),
];
